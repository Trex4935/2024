...
public class Telemetry {
  ...
  private final StructPublisher<Rotation2d> rotation2d =
      table.getStructTopic("Rotation", Rotation2d.struct).publish();
  ...
  private final StructArrayPublisher<SwerveModuleState> modStates =
      driveStats.getStructArrayTopic("MyStates", SwerveModuleState.struct).publish();
  ...
  public void telemeterize(SwerveDriveState state) {
    ...
    modStates.set(state.ModuleStates);
