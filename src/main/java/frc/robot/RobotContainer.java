...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        pivController.a().onTrue(rollers.runOnce(() -> rollers.changeNoteState(NoteState.FIELD)));
        pivController.b().onTrue(rollers.runOnce(() -> rollers.changeNoteState(NoteState.GROUNDINTAKE)));
        pivController.x().onTrue(rollers.runOnce(() -> rollers.changeNoteState(NoteState.GRABBED)));
        pivController.y().onTrue(rollers.runOnce(() -> rollers.changeNoteState(NoteState.CONTROL)));
        pivController.povUp().onTrue(rollers.runOnce(() -> rollers.changeNoteState(NoteState.STORAGE)));
        pivController.povLeft().onTrue(rollers.runOnce(() -> rollers.changeNoteState(NoteState.AMPLOADING)));
        pivController.povRight().onTrue(rollers.runOnce(() -> rollers.changeNoteState(NoteState.AMP)));
        pivController.povDown().onTrue(rollers.runOnce(() -> rollers.changeNoteState(NoteState.SPEAKER)));
        pivController.leftBumper().onTrue(rollers.runOnce(() -> rollers.changeNoteState(NoteState.EJECT)));
        pivController.rightBumper().onTrue(rollers.runOnce(() -> rollers.changeNoteState(NoteState.SOURCE)));
