...
public class Falcon {
  ...
  public static class DefaultConfiguration {
    ...
    public CurrentLimitsConfigs currLimitCfg =
    ...
    public SoftwareLimitSwitchConfigs softwareLimSwitchCfg =
   ...
   *
   * @param id CAN ID of the motor to configure
   ...
   *
   * @param id CAN ID of the motor to configure
   * @param invertMotor If motor direction should be inverted
   * @return Configured TalonFX motor
   */
   ...
   *
   * @param id CAN ID of the motor to configure
   * @param config Config object to use to set values on the motor
   * @return Configured TalonFX motor
   */
  public static TalonFX createFalcon(int id, DefaultConfiguration config, boolean invertMotor) {
    ...
    falcon
        .getConfigurator()
        .apply(new OpenLoopRampsConfigs().withVoltageOpenLoopRampPeriod(config.openLoopRamp));
   ...
   *
   * @param motorObject TalonFX object to configure
   * @param kP Double value of kP portion of PID
   * @param kI Double value of kI portion of PID
   * @param kD Double value of kD portion of PID
   * @param kF Double value of KF portion of PID
   * @return Configured TalonFX motor with PID in ID 0
   */
  public static TalonFX configurePID(
      TalonFX motorObject, double kP, double kI, double kD, double kF) {
   ...
   * @param kD Double value of kD portion of PID
   * @param kF Double value of KF portion of PID
   * @param CruiseVelocity Double cruise speed of motor during motion
   * @param Acceleration Double acceleration to get to cruise speed
   * @return Configured TalonFX motor
   */
  public static TalonFX configMotionMagic(
      TalonFX motorObject,
      double kP,
      double kI,
      double kD,
    ...
    motorObject
        .getConfigurator()
        .apply(new MotorOutputConfigs().withDutyCycleNeutralDeadband(0.001));
    motorObject
        .getConfigurator()
        .apply(new OpenLoopRampsConfigs().withVoltageOpenLoopRampPeriod(0));
