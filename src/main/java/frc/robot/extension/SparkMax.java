...
public class SparkMax {
   ...
   *
   * @param motorObject The motor object
   * @param kP The proportional gain
   * @param kI The integral gain
   * @param kD The derivative gain
   * @param kFF The feed forward
   * @param minVelocity The minimum velocity desired
   * @param maxVelocity The maximum velocity desired
   * @param maxAcceleration The maximum acceleration desired
   * @param error The amount of closed-loop error allowed
   */
  public static CANSparkMax configPIDwithSmartMotion(
      CANSparkMax motorObject,
      double kP,
      double kI,
      double kD,
      double kFF,
   ...
   *
   * @param motorObjectPID A motor object's PID
   * @param kP The proportional gain
   * @param kI The integral gain
   * @param kD The derivative gain
   * @param kFF The feed forward
   * @param kIz The integral zone
   * @param minOutput The minimum motor output desired
   * @param maxOutput The maximum motor output desired
   */
  public static void configPIDforPositionControl(
      SparkPIDController motorObjectPID,
      double kP,
      double kI,
      double kD,
      double kFF,
